...
import ghasemi.abbas.wordpress.fragment.BaseFragment;
import ghasemi.abbas.wordpress.fragment.BookMark;
import ghasemi.abbas.wordpress.fragment.Category;
import ghasemi.abbas.wordpress.fragment.Home;
import ghasemi.abbas.wordpress.fragment.Menu;
import ghasemi.abbas.wordpress.fragment.Search;
import ghasemi.abbas.wordpress.fragment.FinishListener;
import ghasemi.abbas.wordpress.adapter.OnClickListener;

import static ghasemi.abbas.wordpress.builder.BuildApp.doubleClickForExit;
    ...
    public void onBackPressed() {
        ...
        if (doubleClickForExit) {
            ...
            if ((currentTime - preTime) > 2000) {
                Toast.makeText(LuancherActivity.this, "جهت خروج مجددا کلیک کنید ...", Toast.LENGTH_SHORT).show();
                preTime = currentTime;
            } else {
