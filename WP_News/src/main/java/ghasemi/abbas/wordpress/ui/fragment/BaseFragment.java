...
//        }
    ...
    public void showBottomBarPost(boolean show, boolean showComment, boolean isMark) {
        ((MainActivity) getContext()).showBottomBarPost(show, showComment, isMark, show ? new OnClickListener() {
            @Override
    ...
    public void showBottomBarPost(boolean show) {
        ((MainActivity) getContext()).showBottomBarPost(show);
    }
    ...
    public void setButtonBarPostStatus(boolean showWeb, boolean isMark) {
        ((MainActivity) getContext()).setStatus(showWeb, isMark);
    }
